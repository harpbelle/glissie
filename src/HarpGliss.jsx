    ...
    <div style={{
      ...
      {showHelp && (
        <div style={{ background:t.help, border:`1px solid ${t.helpBdr}`, borderRadius:6, padding:12, marginBottom:12, fontSize:14, lineHeight:1.6 }}>
          ...
          <strong>Sound techniques:</strong> Each mode lets you pick how the strings are played, and the notation preview marks the choice with its standard sign. <em>Pluck</em> is the ordinary plucked tone. <em>Harmonics</em> ring an octave above the string that sounds them, soft and bell-like; you play and read them on that string, not on the higher pitch you hear, from 6E to 2F. <em>Près de la table</em> is played close to the soundboard for a thinner, guitar-like tone. <em>Nail</em> is plucked with the fingernail for a bright, sharp attack. <em>Xylophonic</em> is plucked while the far end of the string is damped, giving a wooden, muted, dry and percussive sound, played from 5A to 0G. <em>Étouffé</em> is plucked and immediately muffled for a dry, staccato note. Glissando offers only the techniques that suit a sweep: Pluck (shown as Single), Près de la table, and Nail. Each mode remembers its own technique.<br/><br/>
